# Getting Started with the Ainur Protocol

This document provides a concise, implementation-focused introduction to building agents, connecting runtimes, and exercising the Ainur protocol end to end.
...
This sequence boots a local network, registers the reference Echo agent, and validates task execution and auction flow.
...
- Echo agent registered and addressable via the task API
- Task submission and completion with a non-empty result payload
- Successful auction with selection of the lowest-cost agent
...
- **Protocol Overview**: [00_AINUR_PROTOCOL_OVERVIEW.md](./00_AINUR_PROTOCOL_OVERVIEW.md)
- **Economic Layer**: [01_TEMPORAL_LEDGER.md](./01_TEMPORAL_LEDGER.md)
- **Transport Topics**: [L3-Aether-Topics-v1.md](./L3-Aether-Topics-v1.md)
- **Runtime Interface**: [L5-ARI-v1.md](./L5-ARI-v1.md)
...
1. Review the curated references listed in [README](./README.md)
